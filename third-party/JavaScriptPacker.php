 ...
 *                0,10,62 or 'None', 'Numeric', 'Normal'
 *                default: 62.
...
class JavaScriptPacker {
	...
	public function __construct($_script, $_encoding = 62, $_fastDecode = true, $_specialChars = false)
	{
		...
		$this->_encoding = min((int)$_encoding, 62);
	...
	private function _getEncoder($ascii) {
		return $ascii > 10 ? $ascii > 36 ? '_encode62' : '_encode36' : '_encode10';
	}
...
class ParseMaster {
	...
	public function exec($string) {
		...
		#Sunvas. Все JS кодируются в UTF-8, поэтому нужно добавить параметр u
		$regexp .= $this->ignoreCase ? 'ui' : 'u';
		#Orig: $regexp .= $this->ignoreCase ? 'i' : '';
		#[E] Sunvas
