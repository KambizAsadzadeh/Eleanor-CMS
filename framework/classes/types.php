...
class Types extends Eleanor\BaseClass
{
	...
	public static function TimeZonesOptions($act=false)
	{
		...
		#http://php.net/manual/ru/timezones.others.php Пожалуйста, не используйте описанные здесь временные зоны
		#(кроме UTC), они существуют только по причинам обратной совместимости.
		$tzi=array_diff($tzi,['Brazil/Acre','Brazil/DeNoronha','Brazil/East','Brazil/West','Canada/Atlantic',
			...
			'Etc/GMT-9','Etc/GMT0','Etc/Greenwich','Etc/UCT','Etc/Universal','Etc/UTC','Etc/Zulu','Factory','GB',
			'GB-Eire','GMT','GMT+0','GMT-0','GMT0','Greenwich','Hongkong','HST','Iceland','Iran','Israel','Jamaica',
