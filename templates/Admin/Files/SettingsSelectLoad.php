...
echo Eleanor::Select($service,Eleanor::Option($lang['select_source_code'],'eval',$value=='eval').Eleanor::Option($lang['select_source_input'],'opts',$value=='opts'),array('id'=>'s-opts-'.$u)),
