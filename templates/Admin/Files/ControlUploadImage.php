...
array_push($GLOBALS['scripts'],$write ? 'addons/autocomplete/jquery.autocomplete.js' : false,'addons/swfupload/swfupload.js','addons/colorbox/jquery.colorbox-min.js');
