...
if($var_0=='result')
	return$var_1 ? '<a href="'.$var_1.'" rel="nofollow">'.basename($var_1).'</a>' : '';
...
if($uploaded or $writed)
{
	...
	if($uploaded)
		$r.='<label style="margin:0px 15px">'.Eleanor::Check($name.'[delete]').'<span style="vertical-align:15%"> '.T::$lang['delete'].'</span></label>';
	$r.='</li>';
}
