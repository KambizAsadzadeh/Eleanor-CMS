...
if(!$ajax)
	$c.='<table class="tabstyle tabform" id="edit-control-table"><tr><td class="label">'.$lang['control_type'].'</td><td>'.$a['type'].' '.Eleanor::Button(T::$lang['update'],'button',array('onclick'=>'EC.ChangeType(true)')).'</td></tr>';
...
if(!$ajax)
{
	$GLOBALS['scripts'][]='js/edit_control.js';
