...
return[
	...
	'NAME_TOO_LONG'=>function($l,$e){
		return'Длина имени пользователя не должна превышать '.$l
			.Russian::Plural($l,[' символ',' символа',' символов']).' символов. Вы ввели '.$e
			.Russian::Plural($e,[' символ',' символа',' символов']).' символов.';
	},
	'PASS_TOO_SHORT'=>function($l,$e){
		return'Минимальная длина пароля '.$l.Russian::Plural($l,[' символ',' символа',' символов'])
			.' символов. Вы ввели только '.$e.Russian::Plural($e,[' символ',' символа',' символов'])
			.' символов.';
	},
