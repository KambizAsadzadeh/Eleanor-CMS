...
class VotingManager extends BaseClass
{
	public
		...
		$langs=[],#Языки. Пустое - не мультиязычно, '' - передалось мультиязычно, но нужно сохранить только Language::$main, массив - сохраняем только нужные языки
